...
{
public:
    Particle(RenderTarget& target, int numPoints, Vector2i mouseClickPosition, Vector2i mouseReleasePosition);     //mapping pixels to cartesian coordinates
    virtual void draw(RenderTarget& target, RenderStates states) const override; //usage: window_object.draw(...)
